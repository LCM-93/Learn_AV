...
public class EncodeHandleImp implements EncodeHandle {
    ...
    private int sampleRate = Config.SAMPLE_RATE_IN_HZ; //采样率
    private int channelCount = Config.CHANNEL_COUNT; //声道数
    private int bitRate = Config.BITE_RATE; //比特率
    ...
    private boolean initMediaFormat() {
        try {
            ...
            mMediaFormat.setInteger(MediaFormat.KEY_CHANNEL_COUNT,channelCount);
