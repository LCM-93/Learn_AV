...
#define FFMPEG_CONFIGURATION "--prefix=/Users/chenming/AndroidStudioProjects/ffmpeg-4.1/android/armeabi-v7a --target-os=android --arch=arm --cross-prefix=/Library/Android_SDK/ndk-bundle-r16/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi- --disable-asm --enable-cross-compile --disable-static --enable-shared --enable-runtime-cpudetect --disable-doc --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-doc --disable-symver --enable-small --enable-gpl --enable-nonfree --enable-version3 --disable-iconv --enable-jni --enable-mediacodec --disable-bsfs --disable-indevs --enable-indev=v4l2 --disable-outdevs --disable-filters --disable-postproc --sysroot=/Library/Android_SDK/ndk-bundle-r16/platforms/android-19/arch-arm --extra-cflags='-I/Library/Android_SDK/ndk-bundle-r16/sysroot/usr/include/arm-linux-androideabi -isysroot /Library/Android_SDK/ndk-bundle-r16/sysroot -D__ANDROID_API__=19 -U_FILE_OFFSET_BITS -march=armv7-a -mfloat-abi=softfp -mfpu=neon -marm -Os -fPIC -DANDROID -Wfatal-errors -Wno-deprecated' --extra-cxxflags='-D__thumb__ -fexceptions -frtti' --extra-ldflags=-L/Library/Android_SDK/ndk-bundle-r16/platforms/android-19/arch-arm/usr/lib"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2018
#define FFMPEG_DATADIR "/Users/chenming/AndroidStudioProjects/ffmpeg-4.1/android/armeabi-v7a/share/ffmpeg"
#define AVCONV_DATADIR "/Users/chenming/AndroidStudioProjects/ffmpeg-4.1/android/armeabi-v7a/share/ffmpeg"
